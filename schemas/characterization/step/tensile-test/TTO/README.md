...
This schema **extends** [`characterization/step/base/PMDCo/`](../base/PMDCo/README.md):
...
```text
characterization/step/base/PMDCo/          base schema
...
`characterization/step/base/PMDCo/specs/shape.ttl`, mirroring the `$ref` base at
the schema level.
...
- [Characterization Step base (PMDCo)](../base/PMDCo/README.md): the base schema this one extends
